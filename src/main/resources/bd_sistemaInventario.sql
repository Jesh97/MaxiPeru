DROP DATABASE IF EXISTS bd_maxiperu;
CREATE DATABASE bd_maxiperu
...
CREATE TABLE articulo (
    ...
    densidad DECIMAL(12,8) DEFAULT 0.00000,
...
CREATE TABLE consumo_produccion (
    ...
    cantidad_consumida DECIMAL(12,8) NOT NULL,
    cantidad_requerida_kg DECIMAL(12,8) DEFAULT 0,
    desviacion_kg DECIMAL(12,8) DEFAULT 0,
    id_unidad_consumida INT NOT NULL,
    es_envase_embalaje TINYINT(1) DEFAULT 0,
    comentario_consumo TEXT NULL,
