    ...
    const infoGuiaHTML = gt.id_guia ? `
        ...
        <div class="p-5 border border-orange-300 rounded-xl bg-orange-50/70 shadow-md">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                ...
                <div><strong class="text-gray-600">Punto de Partida:</strong> <span class="font-medium text-gray-800">${mostrarValor(gt.punto_partida)}</span></div>
                <div><strong class="text-gray-600">Punto de Llegada:</strong> <span class="font-medium text-gray-800">${mostrarValor(gt.punto_llegada)}</span></div>
...
function descargarGuiaTransporte() {
    ...
    document.getElementById('guia-punto-partida').textContent = mostrarValor(guia.punto_partida);
    document.getElementById('guia-punto-llegada').textContent = mostrarValor(guia.punto_llegada);
